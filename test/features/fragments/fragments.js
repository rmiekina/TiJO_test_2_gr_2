...
var fragments = function (text)
{
    ...
    var mapping = {
        goodNewsText: element.bind(null, by.id("rafal")),
        abcLabel: element.bind(null, by.id("miekina")),,
        cdeLabel: element.bind(null, by.id("rmiekina")),,
        input: element.bind(null, by.id("rafalm")),
    };
